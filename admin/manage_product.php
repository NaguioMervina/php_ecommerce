                       ...
                       <div class="card-body card-block">
                           <div class="form-group">
                             ...
                             <select class="form-control" name="categories_id">
                                 ...
                                 <?php
                                 $res=mysqli_query($con,"select id,
                                 categories from categories order by categories asc");
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="meta_keyword" placeholder="Enter product meta keyword" class="form-control"><?php echo $meta_keyword?>
                              </textarea>
                           </div>
